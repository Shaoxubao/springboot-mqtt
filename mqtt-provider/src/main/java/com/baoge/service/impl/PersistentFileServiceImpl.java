...
import com.baoge.service.MqttCallbackWrapper;
import com.baoge.service.MqttDeliveryFuture;
import com.baoge.service.MqttPersistentMessage;
...
public class PersistentFileServiceImpl implements PersistentFileService {
    ...
    private void initStorageDir() {
        ...
        storageDir = new File("storage", storageSubdir);
